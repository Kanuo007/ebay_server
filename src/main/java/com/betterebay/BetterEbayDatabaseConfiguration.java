 ...
 */
public class BetterEbayDatabaseConfiguration implements DatabaseConfiguration {
    final static Logger LOGGER = LoggerFactory.getLogger(BetterEbayDatabaseConfiguration.class);
