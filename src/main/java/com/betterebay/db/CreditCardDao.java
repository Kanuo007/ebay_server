...
public class CreditCardDao extends AbstractDAO<CreditCard> {
  ...
  public List<CreditCard> findAllCreditCard() {
    return list(namedQuery("com.betterebay.core.creditcard.findAll"));
  }
  ...
  public List<CreditCard> findByUserId(Long userId) {
    return list(namedQuery("com.betterebay.core.creditcard.findByUserId").setParameter("user_id", userId));
  }
}
