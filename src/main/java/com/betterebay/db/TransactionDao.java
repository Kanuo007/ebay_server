...
public class TransactionDao extends AbstractDAO<Transaction> {
  ...
  public Optional<Transaction> findTransactionByItemId(Long id) {
    return Optional.ofNullable((Transaction) namedQuery("com.betterebay.core.transaction.findTransactionByItemId")
        .setParameter("item_id", id).uniqueResult());
  }

  public Optional<Transaction> findTransactionByBuyerId(Long id) {
    return Optional.ofNullable((Transaction) namedQuery("com.betterebay.core.transaction.findTransactionByBuyerId")
        .setParameter("user_id", id).uniqueResult());
  }

  public Optional<Transaction> findTransactionByBidHistory_id(Long id) {
    return Optional
        .ofNullable((Transaction) namedQuery("com.betterebay.core.transaction.findTransactionByBidHistory_id")
