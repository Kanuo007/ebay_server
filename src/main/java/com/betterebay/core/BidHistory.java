...
@NamedQueries({@NamedQuery(name = "com.betterebay.core.bidhistory.findAll", query = "SELECT b FROM BidHistory b"),
    @NamedQuery(name = "com.betterebay.core.bidhistory.findByBidderId",
        query = "SELECT b FROM BidHistory b WHERE b.bidderId = :bidderId"),
    @NamedQuery(name = "com.betterebay.core.bidhistory.findByItemId",
        query = "SELECT b FROM BidHistory b WHERE b.itemId = :itemId"),
    @NamedQuery(name = "com.betterebay.core.bidhistory.findByBidTime",
        query = "SELECT b FROM BidHistory b WHERE b.bidTime = :bidTime"),
    @NamedQuery(name = "com.betterebay.core.bidhistory.findByHighestPriceByItemId",
