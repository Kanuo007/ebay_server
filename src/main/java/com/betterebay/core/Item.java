...
@Entity
@Table(name = "item")
@NamedQueries({@NamedQuery(name = "com.betterebay.core.item.findAll", query = "SELECT i FROM Item i"),
    @NamedQuery(name = "com.betterebay.core.item.findItemByName",
        query = "SELECT i FROM Item i where i.name = :name"),
    @NamedQuery(name = "com.betterebay.core.item.findItemByNameColorSize",
        query = "SELECT i FROM Item i where i.name = :name and i.color = :color and i.size = :item_size"),
    @NamedQuery(name = "com.betterebay.core.item.findItemByAvailability",
        query = "SELECT i from Item i where i.status = :status"),
    @NamedQuery(name = "com.betterebay.core.item.updateCurrentPrice",
        query = "UPDATE Item i SET i.base_price = :newPrice where i.id = :itemId"),
    @NamedQuery(name = "com.betterebay.core.item.updateStatus",
