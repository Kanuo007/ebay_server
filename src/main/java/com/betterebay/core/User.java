...
@NamedQueries({@NamedQuery(name = "com.betterebay.core.user.findAll", query = "SELECT u FROM User u"),
    @NamedQuery(name = "com.betterebay.core.user.findUserByName",
        query = "SELECT u FROM User u WHERE u.user_name = :name"),
    @NamedQuery(name = "com.betterebay.core.user.findUserByEmail",
        query = "SELECT u FROM User u WHERE u.user_email = :email"),
    @NamedQuery(name = "com.betterebay.core.user.findUserByPassword",
